(() => {
  ...
  (async()=>{try{await load('learning-tracker.js?v=20260912-lms2');await load('presentation-lms-sync.js?v=20260912-lms2');await load('session-lab-button.js?v=20260912-lms2');await load('interactive-nav-base.js?v=20260912-lms2')}catch(e){console.error('ANDESDB presentation runtime',e)}})();
})();