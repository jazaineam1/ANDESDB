(() => {
  ...
  (async()=>{try{
    await load('presentation-performance.js?v=20260912-perf2');
    await load('learning-tracker.js?v=20260912-perf2');
    await load('presentation-lms-sync.js?v=20260912-perf2');
    await load('session-lab-button.js?v=20260912-perf2');
    await load('interactive-nav-base.js?v=20260912-perf2');
