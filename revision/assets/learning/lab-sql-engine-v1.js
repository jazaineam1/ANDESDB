...
function start(){
  ...
  worker=new Worker(new URL('lab-sql-worker-v1.js?v=20260913-feedback1',base));
...
async function validate(sql,reference){await prepare();const r=await call('validate',{sql,reference},10000);return{got:r.got,match:r.match,diagnostic:r.diagnostic||null}}
function isReady(){return ready}
window.ANDES_SQL_ENGINE={version:'1.2.0',prepare,run,explain,validate,isReady,reset};
})();