(() => {
  ...
  if(isPresentation){
    ...
    if(/sesion[-_\s]*1[3-6]/i.test(location.pathname+' '+document.title)){
      /* El minutaje y los productos de microactividad pertenecen a la guía docente.
         La presentación del estudiante conserva contenido, contexto y evidencia,
         pero no impone un cronómetro visible. */
