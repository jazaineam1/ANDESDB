(()=>{
'use strict';
if(window.ANDES_PLATFORM?.version==='2.0.0')return;
const API='https://gnpouhsvsisqoxketlfr.supabase.co/functions/v1/learning-platform',STORE='andesdb.lms.auth.v1';
...
async function bootstrap(fresh=false){if(bootstrapCache&&!fresh)return bootstrapCache;bootstrapCache=await call('bootstrap');return bootstrapCache}
function invalidate(){bootstrapCache=null}
