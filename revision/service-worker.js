const VERSION='andesdb-lms-20260913-v44';
...
const ESSENTIAL=[
  ...
  './assets/learning/course-data.js','./assets/learning/course-story-ui.js','./assets/learning/lms-platform.js','./assets/learning/lms-ux-v1.js','./assets/learning/readings-v5.js','./assets/learning/access-gate.js','./assets/learning/resource-dock-a11y.js','./assets/learning/learning-tracker.js','./assets/learning/analytics-config.js','./assets/learning/analytics.js',
  './assets/learning/interactive-nav.js','./assets/learning/presentation-text-fixes.js','./assets/learning/presentation-story-v1.js','./assets/learning/presentation-story-v2-patch.js','./assets/learning/presentation-story-v3-polish.js','./assets/learning/presentation-story-s15-patch.js','./assets/learning/presentation-selfcontained-v1.js','./assets/learning/presentation-telemetry.js','./assets/learning/presentation-resume.js',
  './assets/learning/lab-content-v4.js','./assets/learning/lab-content-v4-patch.js','./assets/learning/lab-capstone-patch.js','./assets/learning/lab-mcq-v1.js','./assets/learning/lab-ux-v6-patch.js','./assets/learning/lab-runtime-v4.js','./assets/learning/lab-runtime-v5.js','./assets/learning/lab-sql-scaffold-v1.js','./assets/learning/lab-finish-v1.js'
];
...
self.addEventListener('fetch',event=>{const req=event.request;if(req.method!=='GET')return;const url=new URL(req.url);if(!allowed(url))return;
  ...
  const critical=/\/assets\/learning\/(?:interactive-nav|access-gate|resource-dock-a11y|presentation-text-fixes|presentation-story-v1|presentation-story-v2-patch|presentation-story-v3-polish|presentation-story-s15-patch|presentation-selfcontained-v1|course-story-ui|presentation-telemetry|presentation-resume|lab-runtime-v4|lab-runtime-v5|lab-sql-scaffold-v1|lab-capstone-patch|lab-mcq-v1|lab-ux-v6-patch|lab-finish-v1|lms-platform|lms-ux-v1|learning-tracker)\.js$/i.test(url.pathname);
