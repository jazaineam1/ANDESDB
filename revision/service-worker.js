const VERSION='andesdb-lms-20260912-v39';
...
const ESSENTIAL=[
  ...
  './assets/learning/interactive-nav.js','./assets/learning/presentation-text-fixes.js','./assets/learning/presentation-story-v1.js','./assets/learning/presentation-telemetry.js','./assets/learning/presentation-resume.js',
...
self.addEventListener('fetch',event=>{const req=event.request;if(req.method!=='GET')return;const url=new URL(req.url);if(!allowed(url))return;
  ...
  const critical=/\/assets\/learning\/(?:interactive-nav|access-gate|resource-dock-a11y|presentation-text-fixes|presentation-story-v1|course-story-ui|presentation-telemetry|presentation-resume|lab-runtime-v4|lab-runtime-v5|lab-capstone-patch|lab-mcq-v1|lab-ux-v6-patch|lms-platform|lms-ux-v1|learning-tracker)\.js$/i.test(url.pathname);
