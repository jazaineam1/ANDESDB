const VERSION = 'andesdb-auto-4116e46ce678';
...
self.addEventListener('fetch', event => {
  ...
  const isLearningRuntime = /\/assets\/(?:analytics(?:-config)?\.js|learning\/(?:learning-core|presentation-timer)\.js|learning\/learning-plan\.json|pwa-install\.js)$/i.test(url.pathname);
